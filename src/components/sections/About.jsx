      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 lg:px-16 w-full">
        ...
        <div className="lg:col-span-6 space-y-4 text-left">
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 pt-4">
            <div className="bg-[#FFFAFA] border border-slate-100 rounded-2xl p-2 sm:p-4 text-center hover:scale-105 transition-transform duration-300 shadow-sm">
        ...
        <div className="lg:col-span-6 space-y-6 text-left">
          ...
          <div className="relative border-l-2 border-slate-200/60 pl-6 ml-2 space-y-8">
